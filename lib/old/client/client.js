...
class Client extends _events2['default'] {
  ...
  * @returns {Promise}
  */
	findLastMessages(chatId, user, limit) {
		var _this10 = this;
  ...
  * @returns {Promise}
  */
	findFromMessages(chatId, messageId, user, limit) {
		var _this11 = this;
  ...
  * @returns {Promise}
  */
	findAtMessages(chatId, messageId, user, limit) {
		var _this12 = this;
