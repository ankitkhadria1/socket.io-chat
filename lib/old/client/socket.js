...
class ClientSocket {
	...
	onFindMessagesLast(client, socket) {
		var _this8 = this;
	...
	onFindMessagesFrom(client, socket) {
		var _this9 = this;
	...
	onFindMessagesAt(client, socket) {
		var _this10 = this;
