...
var _get = function get(_x7, _x8, _x9) { var _again = true; _function: while (_again) { desc = parent = getter = undefined; _again = false; var object = _x7,
    property = _x8,
    receiver = _x9; var desc = Object.getOwnPropertyDescriptor(object, property); if (desc === undefined) { var parent = Object.getPrototypeOf(object); if (parent === null) { return undefined; } else { _x7 = parent; _x8 = property; _x9 = receiver; _again = true; continue _function; } } else if ('value' in desc) { return desc.value; } else { var getter = desc.get; if (getter === undefined) { return undefined; } return getter.call(receiver); } } };
		...
		var Chat = (function (_Model) {
			...
			_createClass(Chat, [{
				...
				value: function findById(id) {
					var criteria = arguments[1] === undefined ? {} : arguments[1];
				...
				value: function findEqual(chatModel) {
					...
					return queryResolver.collection(collectionName).setQuery(query).findOne().then(function (result) {
						return result && Chat.fill(result);
					});
				}
			}]);
