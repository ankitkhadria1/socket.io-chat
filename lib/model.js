...
class Model extends _events2['default'] {
	constructor() {
		var _this = this;
	...
	setSchema(schema) {
		...
		var readonlyAttrs = _schema2['default'].readOnly(this.schema);
		var indexes = _schema2['default'].index(this.schema);
	...
	static update() {
		...
		_db2['default'].getConnect(function (connect) {
			...
			collection.update.apply(collection, Array.prototype.slice.call(_arguments));
		});
	}
}
