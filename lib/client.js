...
var Client = (function (_BaseClient) {
	...
	function Client(server, options) {
		...
		this.addEvent(EVENT.AUTHENTICATE, this.onAuthenticate).addEvent(EVENT.NEW_CHAT, this.socketAuthorized, this.newChat).addEvent(EVENT.NEW_MESSAGE, this.socketAuthorized, this.newMessage).addEvent(EVENT.START_WRITE, this.socketAuthorized, this.onStartWrite).addEvent(EVENT.END_WRITE, this.socketAuthorized, this.onEndWrite).addEvent(EVENT.FOCUS, this.socketAuthorized, this.onFocus).addEvent(EVENT.BLUR, this.socketAuthorized, this.onBlur);
