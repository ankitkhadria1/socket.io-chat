   ...
   */
    ...
    */
			...
			value: function findChats(user) {
				...
				return new Promise(function (resolve, reject) {
					_this12._validatePath(_this12.EVENTS.FINDCHATS, { user: user, count: count }).then(function () {
			...
			value: function findChatById(user, chatId) {
				...
				return new Promise(function (resolve, reject) {
					_this13._validatePath(_this13.EVENTS.FINDCHAT, { user: user, chatId: chatId }).then(function () {
